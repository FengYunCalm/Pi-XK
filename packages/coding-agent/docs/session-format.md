...
Source on GitHub ([Pi-XK](https://github.com/FengYunCalm/Pi-XK)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/FengYunCalm/Pi-XK/blob/main/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/FengYunCalm/Pi-XK/blob/main/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
- [`packages/ai/src/types.ts`](https://github.com/FengYunCalm/Pi-XK/blob/main/packages/ai/src/types.ts) - Base message types (UserMessage, AssistantMessage, ToolResultMessage)
- [`packages/agent/src/types.ts`](https://github.com/FengYunCalm/Pi-XK/blob/main/packages/agent/src/types.ts) - AgentMessage union type

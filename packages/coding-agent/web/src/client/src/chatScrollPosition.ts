...
export class ChatScrollController {
	...
	savePosition(
		...
		anchors: ChatScrollElement[],
		bottomThreshold = DEFAULT_BOTTOM_SAVE_THRESHOLD,
	): ChatScrollSaveResult {
	...
	restorePosition(
		...
		scroller: ChatScrollViewport | undefined,
		anchors: ChatScrollElement[],
		options?: { fallbackToBottom?: boolean | undefined },
...
export function captureScrollPosition(
	...
	anchor: ChatScrollElement,
): ChatAnchorScrollPosition {
...
export function findVisibleScrollAnchor<T extends ChatScrollElement>(
	scroller: ChatScrollViewport,
	anchors: T[],
): T | undefined {
...
export function findFirstVisibleArticle<T extends ChatScrollElement>(
	scroller: ChatScrollViewport,
	articles: T[],
): T | undefined {
	const scrollerRect = scroller.getBoundingClientRect();
...
function anchorIdForElement(element: ChatScrollElement): string | undefined {
	return element.dataset.scrollAnchorId !== undefined && element.dataset.scrollAnchorId !== ""
		? element.dataset.scrollAnchorId
		: undefined;
}

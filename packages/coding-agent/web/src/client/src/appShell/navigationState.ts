...
export function expandedNavigationSection(
	expanded: ExpandedNavigationSection,
...
export function isNavigationSectionCollapsed(
	...
	options: { isMobileLayout: boolean; expanded: ExpandedNavigationSection; state: NavigationSelectionState },
): boolean {
...
export function toggleNavigationSection(
	expanded: ExpandedNavigationSection,
	section: NavigationSection,
	options: { isMobileLayout: boolean; state: NavigationSelectionState },
...
export function expandNavigationSection(
	expanded: ExpandedNavigationSection,
	section: NavigationSection,
...
export class MobileNavigationController implements ReactiveController {
	...
	toggle(section: NavigationSection): void {
		this.setExpanded(
			toggleNavigationSection(this.expanded, section, {
				isMobileLayout: this.isMobileLayout(),
				state: this.getState(),
			}),
		);

...
export class ActivityController {
	...
	constructor(
		...
		deps: ActivityControllerDependencies = {},
	) {
	...
	applyWorkspaceActivity(activity: WorkspaceActivity): void {
		this.setState({
			workspaceActivities: applyWorkspaceActivityToMap(this.getState().workspaceActivities, activity),
		});
	}
}
...
export function applyWorkspaceActivityToMap(
	current: Record<string, WorkspaceActivity>,
